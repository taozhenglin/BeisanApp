...
import com.guideelectric.loadingdialog.R;
import com.guideelectric.loadingdialog.manager.StyleManager;
...
public class LoadingDialog implements FinishDrawListener {
    ...
    private String alterDIalogTitle = "";
    private boolean secondaryAsk = false;
    ...
    public LoadingDialog(Context context) {
        mContext = context;
        final Context acontent = context;
        // 首先得到整个View
        ...
        mLoadingDialog = new Dialog(context, R.style.loading_dialog) {
            ...
            public void onBackPressed() {
                ...
                if (secondaryAsk) {
                    String title = alterDIalogTitle.isEmpty() ? "结束该操作?" : alterDIalogTitle;
                    AlertDialog.Builder builde = new AlertDialog.Builder(acontent);
                    builde.setMessage(title);
                    builde.setPositiveButton("确定", new OnClickListener() {
                        @Override
...
//        int dip = SizeUtils.px2dip(mContext, size);
     ...
     * @param ask
     */
    public LoadingDialog setSecondaryAsk(boolean ask) {
        this.secondaryAsk = ask;
        return this;
    }
     ...
     * @param title
     */
    public LoadingDialog setSecondaryAskTitle(String title) {
        this.alterDIalogTitle = title;
        return this;
    }
