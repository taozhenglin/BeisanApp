...
import com.cn.beisanproject.activity.ChossenProjectACctivity;
...
public class ChossenProjectAdapter extends RecyclerView.Adapter<ChossenProjectAdapter.MyViewHolder> {
    ...
    public ChossenProjectAdapter(Context context, List <ChossenProjectListBean.ResultBean.ResultlistBean> resultlist, String s) {
        mContext=context;
        mList=resultlist;
        mHight=s;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        SpannableString highlightNo = HighLightUtils.highlight(mContext, "项目: " + mList.get(position).getITEMNUM(), mHight, "#00ff00", 0, 0);
        ...
        holder.tv_check_by.setText("型号规格:"+mList.get(position).getA_MODEL());
        holder.tv_check_starttime.setText("余量: " + mList.get(position).getA_TOTALQTY());
    ...
    public void setData(List<ChossenProjectListBean.ResultBean.ResultlistBean> resultlist, String toString) {
        mList=resultlist;
    }

    public void addAllList(List<ChossenProjectListBean.ResultBean.ResultlistBean> resultlist) {
