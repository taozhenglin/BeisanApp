...
public class ProjectMothAdapter extends RecyclerView.Adapter<ProjectMothAdapter.MyViewHolder> {

    private Context mContext;
    private List<ProjectMonthListBean.ResultBean.ResultlistBean> mList;
    private String mHightlight;

    public ProjectMothAdapter(Context context, List<ProjectMonthListBean.ResultBean.ResultlistBean> resultlist, String hightlight) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.tvRequsetDep.setText("申请部门："+mList.get(position).getA_PURCATALOG());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //进入详情页面
                Intent intent=new Intent(mContext, ProjectMonthDetailActivity.class);
    ...
    public void setData(List<ProjectMonthListBean.ResultBean.ResultlistBean> resultlist, String toString) {
        mList = resultlist;
        mHightlight = toString;
    }

    public void addAllList(List<ProjectMonthListBean.ResultBean.ResultlistBean> resultlist) {
