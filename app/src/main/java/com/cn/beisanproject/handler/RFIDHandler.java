package com.cn.beisanproject.handler;
...
import com.cn.beisanproject.activity.AssertCheckActivity;
...
public class RFIDHandler implements Readers.RFIDReaderEventHandler {
    ...
    // UI and context
    TextView textView;
    private AssertCheckActivity context;
    // general
    ...
    public void onCreate(AssertCheckActivity activity) {
        // application context
        context = activity;
        // Status UI
//        textView = activity.statusTextViewRFID;
    ...
    private void InitSDK() {
        Log.d(TAG, "InitSDK");
        if (readers == null) {
            Log.d("222222==", "CreateInstanceTask().execute()");
            new CreateInstanceTask().execute();
        } else{
            Log.d("222222==", "ConnectionTask().execute()");
    ...
    private class CreateInstanceTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            try {
                ...
                Log.d("CreateInstanceTask222222==", e.toString());
            }
            if (invalidUsageException != null) {
                Log.d("222222==", "invalidUsageException != null");
                readers.Dispose();
                readers = null;
                if (readers == null) {
    ...
    private class ConnectionTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            Log.d("222222","ConnectionTask doInBackground");
            GetAvailableReader();
            if (reader != null)
            {
                Log.d("222222","reader != null");
                return connect();
...
//            textView.setText(result);
    ...
    private synchronized void GetAvailableReader() {
        ...
        try {
            if (readers != null) {
                ...
                Log.d("readers222222==", "" + "readers==null");
            }
        } catch (InvalidUsageException e) {
            e.printStackTrace();
            Log.d("222222catch==", "" + e.toString());
        }
    }
        ...
        if (reader != null) {
            ...
            try {
                if (!reader.isConnected()) {
                    ...
                    reader.connect();
                    LogUtils.d("222222","!reader.isConnected()");
                    ConfigureReader();
                    return "Connected";
                }
            } catch (InvalidUsageException e) {
    ...
    private void ConfigureReader() {
        ...
        LogUtils.d("222222","ConfigureReader()");
        if (reader.isConnected()) {
