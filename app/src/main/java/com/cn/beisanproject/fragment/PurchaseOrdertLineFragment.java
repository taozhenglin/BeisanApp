...
public class PurchaseOrdertLineFragment extends Fragment {
    ...
    public PurchaseOrdertLineFragment(Context context, PurchaseOrderListBean.ResultBean.ResultlistBean resultlistBean, boolean needGet, PurchseContractDetailBean purchseContractDetailBean) {
